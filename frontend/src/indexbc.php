...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            $message = "Request ID " . $request_id . " has been updated to processing.";
            ...
            $conn->commit();
            echo "<p class='success-message'>Request status updated to processing and message recorded successfully.</p>";
        } else {
            $conn->rollback();
...
$sql = "SELECT r.id, r.date_created, r.requested_by, r.review_status, i.description, b.*
        FROM requests r
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form method="post" action="">
                                                                    ...
                                                                    <button type="submit" name="action" value="approve" class="btn btn-success">Process</button>
                                                                </form>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
